...
# response = ReadingPlanService.group_news_for_available_time(0)
# print(response)
    ...
    return [
        {
            ...
            "writer": "Cairo Noleto",
            "reading_time": 9,
            "summary": "A todo o instante diversos dados trafegam pela rede: seja o envio de um e-mail, uma mensagem, foto, arquivo, esses dados partem de um ponto A para um ponto B. Mas como essa comunicação é feita? Para respondermos a essa pergunta, vamos aprender sobre o protocolo TCP/IP.",
            "category": "Tecnologia",
        },
        {
            ...
            "writer": "Cairo Noleto",
            "reading_time": 14,
            "summary": "Você sabia que com a utilização de um arduino é possível fazer sensores de led ou até mesmo aqueles carrinhos autônomos bastante parecidos com um robô? Pois bem, com um arduino em mãos é possível desenvolver diversas coisas que podem trazer algumas facilidades em seu cotidiano.",
            "category": "Tecnologia",
        },
        {
            ...
            "writer": "Cairo Noleto",
            "reading_time": 18,
            "summary": "É fato que todo computador necessita de um sistema operacional para funcionar. Entretanto, diversas opções estão disponíveis no mercado, como o Windows, o Mac OS, o Linux e suas variações.",
            "category": "Tecnologia",
        },
        {
            ...
            "reading_time": 5,
            "summary": "Quando falamos de algoritmos, pensamos em matemática e programação. Porém, temos exemplos de algoritmos que estão muito presentes nas nossas atividades cotidianas.",
            "category": "Tecnologia",
        },
        {
            ...
            "writer": "Lucas Custódio",
            "reading_time": 9,
            "summary": "Gaules, uma das maiores personalidades do mundo de esports brasileiro, divide um pouco de sua experiência de vida e carreira em um webinar com estudantes e ex-estudantes da Escola de Programação Trybe.",
            "category": "Carreira",
        },
        {
